            ...
            <div style={cardStyles.card} ref={templateRef}>
                ...
                <div style={cardStyles.body}>
                    ...
                    <div style={cardStyles.right}>
                        <div>
                            <p style={cardStyles.label}>
                                imię i nazwisko pacjenta
                            </p>
                            <p style={cardStyles.labelEng}>Patient Name</p>
                            <p style={cardStyles.textName}>
                                {formData.fullName}
                            </p>
                        </div>
                        <div>
                            ...
                            <p style={cardStyles.textContent}>
                                {formData.consultantName}
                            </p>
                            <p style={cardStyles.textPhone}>
