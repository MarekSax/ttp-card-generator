...
export const CardTemplate = () => {
  ...
  return (
    <div className={styles.container}>
      {imageSrc && <ImageCropper image={imageSrc} setImage={setCroppedImage} reset={resetImage} />}
      <div>
        ...
        <input type="file" accept="image/*" id="image" onChange={onFileChange} ref={fileInputRef} />
      </div>
      <div style={cardStyles.card} ref={templateRef}>
        <div style={cardStyles.header}>
          ...
          <div>
            ...
            <h4 style={cardStyles.h4}>TTP - Thrombotic Thrombocytopenic Purpura</h4>
          </div>
          <div style={cardStyles.photo}>
            {croppedImage ? (
              <img src={croppedImage} alt="User upload" style={cardStyles.photoContent} />
            ) : (
              <img src="https://placehold.co/350x450" alt="" style={cardStyles.photoContent} />
            )}
          </div>
        </div>
